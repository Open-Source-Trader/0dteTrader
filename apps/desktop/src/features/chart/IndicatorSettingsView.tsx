 ...
 * large-detent sheet. It is not a `Menu`: nothing here is a choice between
 * rows, it is a form of switches and steppers, so it takes the anchored panel
 * and the drop animation the other popups take and keeps its own content
 * inside them. Same treatment, not the same container.
 */
export function IndicatorSettingsView({
  ...
  return (
    <div className="indicator-dropdown">
      <div className="indicator-dropdown-header">
        ...
        <span style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 8 }}>
          <button
            ...
            disabled={settings === DEFAULT_INDICATOR_SETTINGS}
      ...
      <div className="indicator-dropdown-body grouped-list hide-scrollbar">
