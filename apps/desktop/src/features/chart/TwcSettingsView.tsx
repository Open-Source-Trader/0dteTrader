...
/** Just the section rows — reused standalone (compact Sheet) and inline
 *  inside the Indicators tab's Scripts section on desktop grid, where the
 *  whole point is no navigation away from the indicators list. */
