                   ...
                   viewModel.optionsAnalyticsSettings.enabled {
                    Button {
                        ...
                        HStack(spacing: 4) {
                            ...
                            if optionsAnalyticsSettings.showDiagnostics && !snapshot.quality.warnings.isEmpty {
                                Image(systemName: "exclamationmark.triangle.fill")
                            }
                        }
                        .font(.system(size: 8, weight: .bold, design: .monospaced))
                        .foregroundStyle(snapshot.quality.warnings.isEmpty || !optionsAnalyticsSettings.showDiagnostics ? Color.appAccent : Color.appWarning)
