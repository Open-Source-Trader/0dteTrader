...
- **Score justifications:**
  ...
  - Color 6: text contrast passes (primary label ~#FFFFFF on #1C1C1E ≈ 15:1; section-header gray ≈ 5.9:1); on-toggle green ≈ 9:1 — but the green is the _system default_, bypassing the documented `appAccent`-for-toggles token (`AppColors.swift:52`) and colliding with buy/profit green semantics.
